                    ...
                    <tr>
                      ...
                      <td>
                          <div class="form-button-action">
                            <form action="{{ route('skills.destroy',$p->id) }}" method="POST">
                              @csrf
                              @method('DELETE')
                              <button type="button" class="btn btn-warning btn-large" onclick="window.location.href='{{ route('skills.edit',$p->id) }}'">Edit</button>
